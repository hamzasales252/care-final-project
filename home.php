...
<body>
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
      <div class="container">
        <a class="navbar-brand" href="#"><span class="text-primary">Care</span>-Group</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="btn btn-primary ml-lg-3" href="login1.php">Login / Register</a>
            </li>
          </ul>
        </div> <!-- .navbar-collapse -->
      </div> <!-- .container -->
...
if(empty($_POST["doctor"])){
  ...
  $doctor=refine_data($_POST["doctor"]);
    ...
    if(empty($_POST["phone"])){
      ...
      $sql="INSERT INTO appointment (p_name,email,date,department,doctor,phone) 
...
<div class="page-section">
  ...
  <footer class="page-footer">
    <div class="container">
      ...
      <p id="copyright">Copyright &copy; 2022 Care Group. All right reserved</p>
    </div>
  </footer>
