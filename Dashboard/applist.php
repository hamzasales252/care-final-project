  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class='main-panel'>
        ...
        if(!$result){echo "Error while selecting appointment table";}
                      ...
                      <tr>
                        ...
                        <td>
                          <div class='d-flex align-items-center'>
                            ...
                            <a href="appdelete.php?id=<?php echo $row['id']?>" onclick="return confirm('Are You Sure you want to delete?')">Delete
