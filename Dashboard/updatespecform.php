...
// VALUES ('$name','$email','$password','$phone','$image','$city','$specialization','$qualification')";
    ...
    if(empty($_POST["qualification"])){
      ...
      $sql="INSERT INTO test_data (name,email,password,phone,city,specialization,qualification) 
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputSpecialization" placeholder="Specialization" name="specialization"><span class="error">*<?php echo $specializationError?></span>
                    </div>
                    <div class="form-group">
