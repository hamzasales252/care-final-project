  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class='main-panel'>
        ...
        if(!$result){echo "Error while selecting patient table";}
      while($row=mysqli_fetch_array($result)): ?>
                      <tr>
                        ...
                        <td><img src="<?php echo $site_url.'uploadimage/images/'. $row["image"] ?>" alt=""></td>
                        <td>
                          <div class='d-flex align-items-center'>
                            <button type='button' class='btn btn-success btn-sm btn-icon-text mr-3'>
                              <a href="updatepatientform.php?id=<?php echo $row['id']?>">Edit</a>
                              <i class='typcn typcn-edit btn-icon-append'></i>
                            </button>
                            <button type='button' class='btn btn-danger btn-sm btn-icon-text'>
                            <a href="patientdelete.php?id=<?php echo $row['id']?>" onclick="return confirm('Are You Sure you want to delete?')">Delete
