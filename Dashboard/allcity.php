  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class='main-panel'>
        ...
        if(!$result){echo "Error while selecting city table";}
                        ...
                        <td>
                          <div class='d-flex align-items-center'>
                            <button type='button' class='btn btn-success btn-sm btn-icon-text mr-3'>
                              <a href='updatecityform.php?id=<?php echo $row['id']?>'>Edit</a>
                               <i class='typcn typcn-edit btn-icon-append'></i>
                               </button>
                            <button type='button' class='btn btn-danger btn-sm btn-icon-text'>
                            <a href='citydelete.php?id=<?php echo $row['id']?>' onclick='return confirm('Are You Sure you want to delete?')'>Delete
