       ...
       error_reporting(0);
        ...
        $sql="UPDATE city SET `name` = '$name'  WHERE `city`.`id` = $id";
            ...
            if(!$result){
                ...
                //echo error_log("Failed to connect to database!", 0);
            }
            else{
                echo "<script>alert('City Edit Successfully');</script>";
            }
            mysqli_close($connect);
        }
        if(isset($_GET["id"]) && !empty(trim($_GET["id"]))){
          $id=$_GET['id'];
          $data="SELECT * FROM city where id='$id'";
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" placeholder="Name" name="name" value="<?php echo $name?>"><span class="error">*<?php echo $nameError?>
                    </div>
                    <span class="input-group-append">
                        <input type="submit" class="file-upload-browse btn btn-primary" value="Add"/>
                        </span>
                </form> 
              </div>
            </div>
