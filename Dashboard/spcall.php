  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <?php
          ...
          if(!$result){echo "Error while selecting specialization table";}
                      ...
                      <tr>
                        ...
                        <td>
                          <div class='d-flex align-items-center'>
                            ...
                            <a href='specialidelete.php?id=<?php echo $row['id']?>' onclick="return confirm('Are You Sure you want to delete?')">Delete</a>
                            <?php echo "  <i class='typcn typcn-delete-outline btn-icon-append'></i>
                            </button>
                          </div>
                        </td>
                      </tr>
